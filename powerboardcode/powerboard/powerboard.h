...
uint8_t busses12V[11] = { AUX_ACT_CTL, DRIVE_CTL, MULTIMEDIA_ACT_CTL, GIMBAL_ACT_CTL, BUCKCTL, AUX_LOG_CTL, MULTIMEDIA_LOG_CTL, GIMBAL_LOG_CTL, NAV_BOARD_CTL, CAM_CTL, EXTRA_CTL};
uint8_t drivePack = P_DRIVE_CTL;
uint8_t currentSensePack[11] = { P_MOTOR1_SENSE, P_MOTOR2_SENSE, P_MOTOR3_SENSE, P_MOTOR4_SENSE, P_SPARE_SENSE, P_ROCKET_SENSE, P_TWELVE_SENSE, P_VACUUM_SENSE, P_DRIVE_SENSE, P_AUX_SENSE};
uint8_t bussesPack[4] = { P_ROCKET_CTL, P_TWELVE_CTL, P_VACUUM_CTL, P_AUX_CTL};
