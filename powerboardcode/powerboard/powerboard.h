...
uint8_t currentSense12V[10] = {MULTIMEDIA_SENSE, NAV_SENSE, GIMBAL_ACT_SENSE, DRIVE_SENSE, SCISENSOR_ACT_SENSE, NETSWITCH_SENSE, CAM1_SENSE, CAM2_SENSE, BBB_SENSE, AUX_LOG_SENSE};
uint8_t actuation12V[] = {GIMBAL_ACT_CTL, AUX_LOG_CTL, SPARE_CTL, MULTIMEDIA_CTL, SCISENSOR_ACT_CTL};
uint8_t logic12V[] = {GIMBAL_LOG_CTL, NAV_CTL, DRIVE_CTL, NETSWITCH_CTL, CAM1_CTL, CAM2_CTL, BBB_CTL, SPARE_CTL};
...
uint8_t bussesPack[2] = {P_AUX_CTL, P_POE_CTL};
