...
uint8_t actuation12V[3] = { AUX_ACT_CTL, MULTIMEDIA_ACT_CTL, GIMBAL_ACT_CTL};
uint8_t logic12V[7] = {DRIVE_CTL, AUX_LOG_CTL, MULTIMEDIA_LOG_CTL, GIMBAL_LOG_CTL, NAV_BOARD_CTL, CAM_CTL, EXTRA_CTL};
